...
In this bonus-walkthrough, we have seen how to take the unmixed fluorophore outputs, and modify the existing raw .fcs file so that the parameters and keywords slots contain only the unmixed data. 

Couple last blurb wrap up sentences

To go back to the main unmixing walk-through, click [here](/course/14_Unmixing/index.qmd#internal-extravaganza)
