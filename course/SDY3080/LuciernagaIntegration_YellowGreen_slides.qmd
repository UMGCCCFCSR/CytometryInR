...
For the YouTube recording, see [here](https://www.youtube.com/live/nviugr9cLFc?si=4gbWKfNCoAhtVi55&t=84)
...
::: {.fragment}
::: {.callout-tip title="."}
At this point, lets just compare the more abundant signatures vs. the reference via `QC_WhatsThis()`. 
:::
:::
...
::: {.fragment}
::: {.callout-tip title="."}
Retrieving the underlying data for the signature variants, lets keep the median "Average" signature, as well as a couple variants and see how they compare to the reference control using `QC_WhatsThis()`
:::
:::
