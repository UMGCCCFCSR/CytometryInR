...
For screen-shot slides, click [here](/course/11_DataForStats/slides.qmd)
...
After [setting up](/course/00_Git/index.qmd#new-folder-from-template) a "Week11" project folder, copy over the contents of "course/11_DataForStats/data" to that folder. This will hopefully prevent merge issues next week when attempting to pull in new course material. Once you have your new project folder organized, remember to [commit](/course/00_Git/index.qmd#push) and push your changes to GitHub to maintain remote version control. 
