...
I then tried to install CytoExploreR again, however the same error message as previous kept appearing. I noticed the superheat version that was installed (0.1.0) did not match the version required as a dependecy for CytoExploreR (>= 1.0.0). I believe using the pak function to install superheat defaulted to installing the CRAN version, which was outdated. 
