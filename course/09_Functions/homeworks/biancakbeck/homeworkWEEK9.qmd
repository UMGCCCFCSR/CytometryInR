...
CellConcentration <- function(x, subset, dilutionMultiplier){
    ...
    # difference
    AcquisitionTime <- as.numeric(EndTime_hms - StartTime_hms) # Just seconds
AcquisitionTime <- AcquisitionTime / 60 # Convert To minutes
...
#After your answers, got it corrected! Thank you
```