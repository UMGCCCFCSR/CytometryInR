...
```{r}
# total.data.location <- file.path("Cytometry Carlos", "08_WaysToGate", "homeworks", "data")
...
```{r}
 ds.data.location <- file.path("Cytometry Carlos", "08_WaysToGate", "homeworks", "downsampled data")
...
```{r}
csv.location <- file.path("Cytometry Carlos", "08_WaysToGate", "homeworks")
# csv.location <- "homeworks"
template <- data.table::fread(file.path(csv.location, "opencyto_template.csv"))
template
```
